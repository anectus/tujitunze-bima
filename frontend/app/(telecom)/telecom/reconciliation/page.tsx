    ...
    <div>
      ...
      <div className="p-4 sm:p-8">
        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-6 shadow-md">
          ...
          <p className="text-lg font-bold text-gray-900">Upload Telecom Records</p>
          <p className="mt-1 text-sm text-gray-500">
            Paste your own operator-side contribution records (CSV: reference,amount,date) —
            each row is matched against HSIMS&apos;s contribution records by reference and amount.
          </p>
          ...
          {uploadResult && (
            <div className="mt-4 rounded-lg bg-blue-100 px-4 py-3 text-sm text-blue-700">
              ...
              {uploadResult.unmatchedCount} unmatched out of {uploadResult.totalUploaded}.
            </div>
          )}
              ...
              <table className="w-full text-left text-sm">
                ...
                <thead className="bg-gray-50 text-xs uppercase text-gray-500">
                  <tr>
                    ...
                    <th className="px-6 py-3 font-semibold">Unmatched</th>
