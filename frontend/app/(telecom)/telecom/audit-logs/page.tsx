      ...
      <div className="p-4 sm:p-8">
        ...
        {loading ? (
          ...
          <div className="space-y-6">
            ...
            {/* API Access Logs */}
            <div>
              <p className="mb-2 text-sm font-semibold text-gray-700">API Access Logs</p>
            ...
            <div className="rounded-2xl border border-dashed border-gray-200 bg-gray-50 p-6 text-center">
              <p className="text-gray-600">Authentication Logs</p>
              <p className="mt-2 text-sm text-gray-400">
                ...
                there&apos;s nothing telecom-specific to show here until that&apos;s built.
              </p>
            </div>
